# Unit 3.4 — Hệ sinh thái & Sự sinh tồn (Ecosystem Change & Survival)

## Tổng quan

| | |
|---|---|
| **Câu hỏi chủ đạo** | Vì sao động vật và thực vật sống ở nơi chúng sống, và em nên làm gì khi nơi đó thay đổi? |
| **Câu hỏi gốc (EN)** | Why do animals and plants live where they do and what should we do when it changes? |
| **Hiện tượng neo** | Bò biển (manatee) tham gia bầy cá heo gần Tampa Bay — "Bầy lạ" (Odd Pod). Sau đó: bò biển bị đe dọa do thay đổi môi trường. |
| **NGSS Standards** | 3-LS2-1, 3-LS4-3, 3-LS4-4, 3-ESS3-1 |
| **Thời lượng** | 13 lessons · ~5 tuần |
| **Nguồn (storyline)** | https://openscied-uploads-production.s3.amazonaws.com/G3_UCH/preview/unit-materials/3.4%20Storyline.pdf |
...
- Mỗi loài có **nhu cầu sống** riêng (thức ăn, nước, nơi ở, nhiệt độ)
- **Môi trường sống (habitat)** = nơi đáp ứng nhu cầu của một loài
- Khi môi trường **thay đổi**, loài có thể không sống được nữa
- Một số động vật **sống thành bầy** để bảo vệ, săn mồi, nuôi con
- **Hoạt động của con người** có thể phá hủy môi trường sống
- **Kỹ thuật** có thể giúp bảo vệ loài (như tạo vùng nước ấm, hạn chế tàu)
- Cùng một vấn đề có **nhiều giải pháp** — cần đánh giá để chọn tốt nhất
- **Bảo tồn** là trách nhiệm của con người
