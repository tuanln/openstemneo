# Unit 3.2 — Thời tiết & Thiên tai (Weather & Hazards)

## Tổng quan

| | |
|---|---|
| **Câu hỏi chủ đạo** | Vì sao cây trái chỉ mọc tốt ở một số nơi, và làm sao em bảo vệ chúng? |
| **Câu hỏi gốc (EN)** | Why do plants only grow well in certain places, and how can we protect them? |
| **Hiện tượng neo** | Căn-tin trường có táo, chuối, cam quanh năm — làm sao có thể? Sau đó: cây trái bị bão phá. |
| **NGSS Standards** | 3-ESS2-1, 3-ESS2-2, 3-ESS3-1, 3-LS1-1 |
| **Thời lượng** | 12 lessons · ~5 tuần |
| **Nguồn (storyline)** | https://openscied-uploads-production.s3.amazonaws.com/G3_UWH/preview/unit-materials/3.2%20Storyline.pdf |
...
- Mỗi loại cây có **nhu cầu khác nhau** về nước, nhiệt độ, ánh sáng
- **Khí hậu** = mẫu nhiệt độ + mưa lâu dài → quyết định nơi cây mọc tốt
- Có nhiều **vùng khí hậu** khác nhau trên Trái Đất
- **Thời tiết nguy hiểm** (bão, lụt, băng giá) có thể phá hủy cây trồng
- **Kỹ thuật** có thể giúp bảo vệ cây — như chắn gió, chống lụt
- **Tiêu chí** và **giới hạn** giúp đánh giá thiết kế
- Một thiết kế có thể có **nhiều giải pháp** — cần so sánh để chọn tốt nhất
