...
## 18 Teacher Editions THCS + 4 Storyline Tiểu học — Bảng tổng quan

### Tiểu học Lớp 3 (4 đơn vị · 53 lessons) — OpenSciEd Elementary

> **Lưu ý**: chỉ có **storyline PDF** công khai. Teacher Edition đầy đủ yêu cầu đăng nhập tài khoản OpenSciEd. Việt hóa dựa trên storyline + pedagogy đã hiểu rõ qua THCS.
...
| **3.3** | Đặc điểm & Sự khác biệt | 14 | ✅ 14/14 | [G3_UTV](https://openscied-uploads-production.s3.amazonaws.com/G3_UTV/preview/unit-materials/3.3%20Storyline.pdf) |
| **3.4** | Hệ sinh thái & Sự sinh tồn | 13 | ✅ 13/13 | [G3_UCH](https://openscied-uploads-production.s3.amazonaws.com/G3_UCH/preview/unit-materials/3.4%20Storyline.pdf) |
...
| Đơn vị | Tên Việt | Trang | Kích thước | Bài học | Việt hóa | Nguồn |
|---|---|---|---|---|---|---|
| **7.1** | Phản ứng hóa học & Vật chất | 334 | 54.1 MB | 14 | ✅ 14/14 | [G7_UCA](https://openscied-uploads-production.s3.amazonaws.com/G7_UCA/hires/7.1%20Chemical%20Reactions%20%26%20Matter%20Teacher%20Edition.pdf) |
...
| Đơn vị | Tên Việt | Trang | Kích thước | Bài học | Việt hóa | Nguồn |
|---|---|---|---|---|---|---|
| **8.1** | Lực tiếp xúc & Va chạm | 374 | 8.0 MB | 16 | ✅ 16/16 | [G8_UCF](https://openscied-uploads-production.s3.amazonaws.com/G8_UCF/lowres/8.1%20Contact%20Forces%20Teacher%20Edition.pdf) |
...
Đã xong:    Unit 6.1 (8/8 lessons)        ~3.0% tổng nội dung
            ...
            Unit 7.1 (14/14 lessons)      ~5.2% — CẤP 2 LỚP 7 SAMPLE ✅
            Unit 8.1 (16/16 lessons)      ~6.0% — CẤP 2 LỚP 8 SAMPLE ✅

Chiến lược mới: mỗi cấp/lớp làm 1 unit đầu làm sample
- Lớp 6: ✅ HOÀN TẤT (full grade)
- Lớp 7: ✅ Unit 7.1 sample
- Lớp 8: ✅ Unit 8.1 sample
- Lớp 3 (cấp 1): Unit 3.1 only (sample, sắp tới)

Tổng: 116/268 lessons (43.3%)
Đơn vị hoàn thành: 8/18 (44%)
🎓 LỚP 6: 86/86 (100%)
✅ Lớp 7 sample: 14/14 Unit 7.1
✅ Lớp 8 sample: 16/16 Unit 8.1
```
