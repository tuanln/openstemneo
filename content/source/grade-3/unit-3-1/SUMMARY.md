# Unit 3.1 — Lực & Tương tác (Forces & Interactions)

## Tổng quan

| | |
|---|---|
| **Câu hỏi chủ đạo** | Làm sao em thiết kế được những vật thể có thể đứng cân bằng và chuyển động theo nhiều cách khác nhau? |
| **Câu hỏi gốc (EN)** | How can we design objects to balance and move in different ways? |
| **Hiện tượng neo** | Những bức tượng nghệ thuật cân bằng và chuyển động theo cách kỳ lạ — bao gồm cả tượng dùng nam châm. |
| **NGSS Standards** | 3-PS2-1, 3-PS2-2, 3-PS2-3, 3-PS2-4 |
| **Thời lượng** | 14 lessons · ~5 tuần |
| **Nguồn (storyline)** | https://openscied-uploads-production.s3.amazonaws.com/G3_UFI/preview/unit-materials/3.1%20Storyline.pdf |

## Danh sách bài học

| # | Tiêu đề tiếng Việt | Tiêu đề gốc EN | Loại | Trạng thái |
|---|---|---|---|---|
| 1 | Những bức tượng kỳ lạ — chúng cân bằng và chuyển động thế nào? | How do these sculptures balance and move? | phenomenon | ✅ |
| 2 | Làm sao xây một bức tượng đứng cân bằng được? | How can we build a sculpture that will balance? | investigation | ✅ |
...
- **Trọng lượng** là một loại lực — vật nặng hơn có lực mạnh hơn
- Cân bằng = các lực **bằng nhau** ở hai bên điểm cân bằng
- **Lực cân bằng** (cùng cường độ, ngược chiều) → vật không chuyển động
- **Lực không cân bằng** → vật chuyển động hoặc thay đổi chuyển động
- **Lực tiếp xúc**: khi hai vật chạm nhau (đẩy/kéo)
- **Lực không tiếp xúc**: nam châm + lực hút trái đất (không cần chạm)
- Nam châm có **hai cực** — cùng cực đẩy, khác cực hút
- Sức hút mạnh hơn khi **gần hơn**, yếu hơn khi **xa hơn**
- Có thể **dự đoán** chuyển động dựa vào lực tác động
