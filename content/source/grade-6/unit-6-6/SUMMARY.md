# Unit 6.6 — Tế bào & Hệ cơ thể (Cells & Systems)

## Tổng quan

| | |
|---|---|
| **Câu hỏi chủ đạo** | Cơ thể sinh vật tự chữa lành như thế nào? |
| **Câu hỏi gốc (EN)** | How do living things heal? |
| **Hiện tượng neo** | Một học sinh trung học bị tạ rơi vào chân, gãy hai xương, rách da. Bốn tháng sau bạn ấy đi lại bình thường — cơ thể đã làm điều đó bằng cách nào? |
| **NGSS Standards** | MS-LS1-1, MS-LS1-2, MS-LS1-3, MS-LS1-8 |
| **Thời lượng** | 14 lessons · ~5 tuần |
| **Trang PDF** | 368 |
| **Kích thước** | 11.1 MB |
| **Nguồn** | https://openscied-uploads-production.s3.amazonaws.com/G6_UCL/lowres/6.6%20Teacher%20Edition.pdf |

## Danh sách bài học

| # | Tiêu đề tiếng Việt | Tiêu đề gốc EN | Trang | Trạng thái |
|---|---|---|---|---|
| 1 | Chuyện gì xảy ra trong chân bạn ấy để đi lại được? | What happened in the student's foot so they could walk again? | 25 | ✅ |
| 2 | Xương, da, cơ làm gì cho chúng ta? | What do our bones, skin, and muscles do for us? | 57 | ✅ |
...
- Mọi sinh vật được tạo từ **tế bào** — đơn vị cơ bản của sự sống
- Cơ thể có nhiều **hệ cơ quan** (xương, cơ, da, máu, thần kinh) phối hợp với nhau
- Khi bị thương, tế bào **chia (mitosis)** để tạo tế bào mới lấp khoảng trống
- Tế bào cần **vật chất** (thức ăn, nước, oxy) và **năng lượng** để hoạt động và phân chia
- Cơ thể phục hồi qua nhiều quy mô: từ phân tử → tế bào → mô → hệ cơ quan
